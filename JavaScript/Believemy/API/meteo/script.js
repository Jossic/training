...
if ("geolocation" in navigator) {
    navigator.geolocation.watchPosition((position) => {
        const url = "http://api.openweathermap.org/data/2.5/weather?lon=" + position.coords.longitude + '&lat=' + position.coords.latitude + "&appid=593934f72669afa98c34ac1c17718026&units=metric";
